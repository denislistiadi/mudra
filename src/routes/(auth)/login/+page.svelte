...
<div class="space-y-8">
	...
	<form method="POST" use:enhance class="space-y-5">
		...
		<PasswordInput required error={errors.password?.[0]} />

		<button
			type="submit"
			class="mt-2 w-full rounded-lg bg-sky-600 py-2.5 text-sm font-medium text-white
			       transition hover:bg-sky-700 focus:ring-2 focus:ring-sky-500/40 focus:outline-none"
		>
			Sign in
		</button>
	</form>
	...
	<p class="text-center text-sm text-zinc-500">
		...
		<a href="/register" class="font-medium text-sky-600 hover:text-sky-700"> Create one </a>
	</p>
</div>
